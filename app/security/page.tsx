...
const updated={ru:'Практики продукта · версия 2.0',en:'Product practices · version 2.0'}
const sections={
 ru:[
  ...
  {title:'Журналы и операции',body:['Изменения основных финансовых сущностей фиксируются в журнале действий без копирования чувствительного содержимого строк. Критические операции требуют AAL2/MFA, а события согласования защищены отдельной restrictive RLS-политикой. Ошибки серверных процессов могут записываться в отдельный технический журнал для диагностики.']},
 ...
 en:[
  ...
  {title:'Audit and operations',body:['Changes to core financial entities are recorded as metadata-only audit events without copying sensitive row contents. Critical operations require AAL2/MFA, and approval events are protected by a separate restrictive RLS policy. Server process failures can be written to a separate operational event log for diagnosis.']},
