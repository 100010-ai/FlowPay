...
requireAll('app/api/admin/overview/route.ts',[
  ...
  'workspace_audit_log','system_event_logs','legal_acceptances','provider_rules','systemErrors24h','apiRequests7d','apiSuccessRate','coverage','version: \'1.8.0\''
])
...
if(!/^1\.(?:7|8)\./.test(String(pkg.version||''))) failures.push(`expected version 1.7.x, found ${pkg.version}`)
